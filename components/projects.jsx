    ...
    return (
        <div id='projects' className="carousel-wrapper text-white z-10" >
            <Carousel infiniteLoop dynamicHeight={false} >
                <div id='hangman-game' tabIndex={14} className='relative h-[100vh] w-[100vw]'>
                    ...
                    <div className='relative'>
                        <iframe className="relative h-[100vh] w-[100vw]"
                ...
                <div id='to-do-list' tabIndex={20} className="relative h-[100vh] w-[100vw]">
                ...
                <div id='image-editor' tabIndex={30} className='relative h-[100vh] w-[100vw]'>
                ...
                <div id=' react Pokémon pagination' tabIndex={30} className='relative h-[100vh] w-[100vw]'>
                ...
                <div id='Malala yousafzai website' tabIndex={30} className='relative h-[100vh] w-[100vw]'>

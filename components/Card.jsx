  ...
  useEffect(() => {
    for (var i = 0; i < text.length; i++) {
      setTimeout(() => {
        if (i == text.length - 1) {
          if (links == 'GTD') {
            seticons(<><a target={'_blank'} title='github' className='mr-[auto]' href="https://github.com/baraa-baba">
              <Image src={githubicon} alt='github icon' height='75' width='75' />
            </a> <a target={'_blank'} title='twitter' className='m-auto'
              href="https://twitter.com/baraa_baba">
                <Image src={twittericon} alt='twitter icon' height='75' width='75' />
              </a>
              <a target={'_blank'} title='dev.to' className='m-auto'
            ...
            seticons(<><a target={'_blank'} title='freelancer' className='mr-[auto]'
              href="https://www.freelancer.com/u/baraa12baba">
              <Image src={freelancericon} alt='freelancer icon' height='75' width='75' />
            </a> <a target={'_blank'} title='mostqel' className='m-auto'
